...
?>
    ...
    <head>
        ...
        <title>Awesome &mdash; Natureza</title>
    ...
    <body>
                        ...
                        <div class="gtco-container">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
                                    <p>Aqui podemos encontrar alguns wallpapers de Natureza</p>
                                </div>
                            </div>
                            <?php
                                include './includes/dbh.php';

                                    $query = $conn->query("SELECT * FROM natureza ORDER BY natureza_uploaded_on ASC");

                                    if($query->num_rows > 0){
                                        while($row = $query->fetch_assoc()){
                                            $imageURL = 'uploads/natureza/'.$row['natureza_file_name'];
                                            $image = $row['natureza_file_name'];
        ...
        <footer id="gtco-footer" role="contentinfo">
            <div class="gtco-container">
                <form action="includes/upload_natureza.php" method="post" enctype="multipart/form-data">
                    <?php
