...
?>
    ...
    <head>
        ...
        <title>Awesome &mdash; Animais</title>
    ...
    <body>
                        ...
                        <div class="gtco-container">
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2 text-center gtco-heading animate-box">
                                    <p>Aqui podemos encontrar alguns wallpapers de Animais</p>
                                </div>
                            </div>
                            <?php
                                include './includes/dbh.php';

                                    $query = $conn->query("SELECT * FROM animais ORDER BY animais_uploaded_on ASC");

                                    if($query->num_rows > 0){
                                        while($row = $query->fetch_assoc()){
                                            $imageURL = 'uploads/animais/'.$row['animais_file_name'];
                                            $image = $row['animais_file_name'];
        ...
        <footer id="gtco-footer" role="contentinfo">
            <div class="gtco-container">
                <form action="includes/upload_animais.php" method="post" enctype="multipart/form-data">
                    <?php
